...
class calverter:
    ...
    def __init__(self):
        ...
        self.J0000 = 1721424.5
        # Julian date at Unix epoch: 1970-01-01
        self.J1970 = 2440587.5
    ...
    def leap_gregorian(self, year):
        """
        LEAP_GREGORIAN: Is a given year in the
        Gregorian calendar a leap year?
        """
    ...
    def gregorian_to_jd(self, year, month, day):
        """
        GREGORIAN_TO_JD: Determine Julian day number
        from Gregorian calendar date
        """
        ...
        return (self.GREGORIAN_EPOCH - 1) + (365 * (year - 1)) + \
            math.floor((year - 1) / 4) + \
    ...
    def jd_to_gregorian(self, jd):
        ...
        # Python 2.5
        #leapadj = 0 if wjd < self.gregorian_to_jd(year, 3, 1)
    ...
    def iso_day_to_julian(self, year, day):
        """
        ISO_DAY_TO_JULIAN: Return Julian day of given ISO year,
        and day of year
        """
    ...
    def leap_jalali(self, year):
        ...
        # Python 2.5
        #return ((((((year - 474 if year > 0 else 473 )
        #        % 2820) + 474) + 38) * 682) % 2816) < 682
        #
